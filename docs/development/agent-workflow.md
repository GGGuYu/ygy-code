...
| --------------------------------------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Orientation and context delivery                    | `PARTIAL`        | Root `AGENTS.md` provides the package map, invariants, commands, safety notes, and links here; ygy-code's documented knowledge chain consumes it.                                          | Loading and enforcement by other agent hosts are unverified. Fall back to explicitly opening `AGENTS.md`; reevaluate when a supported host or instruction path changes.                                             |
