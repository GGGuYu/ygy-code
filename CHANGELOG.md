...
- load user + project slash commands from .ygy-code/commands (59f429d)
...
- honor YGY_CODE_HOME for plugin paths and user-scope settings (da4f227)
...
- gitignore .ygy-code/ project state (c7ff756)
...
- interactive /model picker + persist choice to ~/.ygy-code/config.json (ffa11ff)
...
- /model picker choice beats YGY_CODE_MODEL env var (a1a3533)
