import { MODEL_ALIASES } from '@ygy-code/core'
...
export const INIT_PROMPT = `Please analyze this codebase and create an AGENTS.md file at the project root. AGENTS.md is loaded into every ygy-code (\`ygy\`) session, so future agents will read it as their primary project context.
