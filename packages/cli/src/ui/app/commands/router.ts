import { errorMessage, expandCommandBody, wrapActivatedSkill } from '@ygy-code/core'
import type { AgentOptions, SkillDefinition } from '@ygy-code/core'
    ...
    case 'list-agents': {
      ...
      try {
        ...
        agent.addCommandResult(
          peers.length === 0
            ? 'No other reachable ygy-code sessions.'
            : `${peers
                .map(
                  (peer) =>
