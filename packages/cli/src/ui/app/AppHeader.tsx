// @ygy-code/cli — Startup header banner
//
...
import { GLYPH_HEADER_PIPE } from '../render/terminal-glyphs.js'
import { chalk as c, paint } from '../render/tokens.js'
