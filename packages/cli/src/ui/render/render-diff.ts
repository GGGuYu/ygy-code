// @ygy-code/cli — Render a writeFile / edit diff payload to ANSI text.
//
...
import { stripTerminalControls } from '@ygy-code/core'
import type { EditDiffHunk, EditDiffPayload } from '@ygy-code/core'
    ...
    hunks: [
      {
        ...
        newStart: 1,
        newLines: 3,
        lines: [' function greet() {', '-  console.log("Hello, World!");', '+  console.log("Hello, ygy-code!");', ' }'],
      },
    ],
    additions: 1,
    removals: 1,
