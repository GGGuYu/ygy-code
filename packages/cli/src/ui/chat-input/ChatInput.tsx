// @ygy-code/cli — Bottom dynamic region (spinner + input box) AND the
...
import { debugLog, suggestRuleLabel } from '@ygy-code/core'
...
export function ChatInput({
  ...
  /** Non-null while the "No, and tell ygy-code what to do instead" row is
  ...
  useEffect(() => {
    ...
    // initial prompt (`ygy "hi"`) clipped the top half of the logo.
    ...
    if (permission) {
      ...
      options.push({ label: 'No, and tell ygy-code what to do instead', shortcut: 'f' })
