// @ygy-code/cli — ModelMessage → DisplayMessage conversion.
//
...
// agent loop.
import type { DisplayMessage, DisplayToolCall, ModelMessage } from '@ygy-code/core'
import { TOOL_SEARCH_TOOL_NAME, extractText } from '@ygy-code/core'
