import type { AgentOptions, LanguageModel, TerminateAllResult, TerminationReason } from '@ygy-code/core'
...
vi.mock('@ygy-code/core', async (importOriginal) => {
  const original = await importOriginal<typeof import('@ygy-code/core')>()
  return {
    ...original,
