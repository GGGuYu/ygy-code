// @ygy-code/core — Per-provider prompt caching
//
...
export const XAI_PROMPT_CACHE_KEY_HEADER = 'x-ygy-code-prompt-cache-key'
export const OPENAI_SESSION_ID_HEADER = 'x-ygy-code-openai-session-id'
