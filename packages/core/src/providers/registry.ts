// @ygy-code/core — AI SDK Provider Registry (multi-model support)
...
export function createModelRegistry() {
  ...
  if (openAIAuth.context.mode !== 'none') {
    providers.openai = createOpenAI({
      apiKey: openAIAuth.context.mode === 'api-key' ? openAIAuth.context.apiKey : 'ygy-code-dynamic-openai-auth',
...
const ZHIPU_REASONING_HEADER = 'x-ygy-code-zhipu-reasoning-effort'
...
/** Move ygy-code's per-session affinity hint to the wire location required by
