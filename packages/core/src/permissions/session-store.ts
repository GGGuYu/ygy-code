// @ygy-code/core — Permission memory with disk persistence.
//
...
// `.ygy-code/local/permissions.json`. On next startup the persisted rules
...
/**
 * Load persisted permission rules from `.ygy-code/local/permissions.json`
