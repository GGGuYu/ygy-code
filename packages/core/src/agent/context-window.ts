// @ygy-code/core — Context window lookup & estimation
...
/** Resolve the raw/configured context ceiling for a model id like `provider:model`.
 *  Safety headroom is applied exactly once by getCompressionThreshold(). */
