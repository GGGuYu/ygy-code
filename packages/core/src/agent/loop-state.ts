// @ygy-code/core — Shared agent loop state
...
export interface LoopState {
  ...
  /** Path to the plan file when in plan mode (`.ygy-code/plans/{sessionId}.md`),
 ...
 *  which was unreadable in `ls .ygy-code/sessions/` — the timestamp shape
