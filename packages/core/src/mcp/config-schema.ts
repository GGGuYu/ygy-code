// @ygy-code/core — MCP config Zod schema
//
// Validates the `mcpServers` field of ~/.ygy-code/config.json (and the
// project-level .ygy-code/config.json). One schema covers both stdio and
