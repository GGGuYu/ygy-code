// @ygy-code/core — Slash-command argument parser for /mcp add/add-json/remove
//
...
//     paths like `D:\res\ygy-code\tmp` — full POSIX-style escape would
  ...
  while (i < n) {
    ...
    while (i < n && inToken) {
      ...
      if (c === '\\' && i + 1 < n) {
        ...
        // like `D:\res\ygy-code\tmp` survive — eating those backslashes
