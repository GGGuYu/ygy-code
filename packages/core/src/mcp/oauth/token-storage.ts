// @ygy-code/core — Per-server OAuth token + client info persistence
//
// One file: ~/.ygy-code/mcp-auth.json
//
//   {
//     "sentry": {
...
function authFile(): string {
  return path.join(userYgyDir(), 'mcp-auth.json')
}
 ...
 *  ~/.ygy-code/. Note that YGY_CODE_HOME also reroutes the file, so most
